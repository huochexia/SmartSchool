...
class GoodsManagerFragment : BaseFragment<FragmentGoodsListBinding>() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel!!.selected.observe(this, Observer {
            viewModel!!.getGoodsOfCategory(it)
            adapter!!.forceUpdate()
        })
    ...
    private fun deleteDialog(position: Int) {
        val dialog = AlertDialog.Builder(context)
            ...
            .setPositiveButton("确定") { dialog, _ ->
                ...
                viewModel!!.deleteGoods(viewModel!!.goodsList[position])
                ...
                viewModel!!.goodsList.removeAt(position)
                adapter!!.forceUpdate()
                dialog.dismiss()
            }.create()
        dialog.show()
        ...
        val dialog = AlertDialog.Builder(context)
            ...
            .setPositiveButton("确定") { dialog, _ ->
                ...
                if (name.isNullOrEmpty() || unit.isNullOrEmpty()) {
                    ...
                    viewModel!!.updateGoods(goods).subscribeOn(Schedulers.computation())
                        .subscribe()
                    adapter!!.forceUpdate()
                    dialog.dismiss()
                }
