package com.owner.basemodule.widgets.charsidebar
 ...
 * 波浪侧边栏
 */
class WaveSideBar @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) :
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        ...
        if (attrs != null) {
            ...
            mRadius = a.getDimensionPixelSize(
                ...
                context.resources.getDimensionPixelSize(R.dimen.radius)
            )
            mCircleRadius = a.getDimensionPixelSize(
                R.styleable.waveSideBar_circleRadius,
                context.resources.getDimensionPixelSize(R.dimen.circleRadius)
            )
            a.recycle()
        }
